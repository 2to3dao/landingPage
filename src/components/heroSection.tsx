        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="max-w-2xl mx-auto px-6 text-lg text-gray-600 font-inter">
              At 2to3DAO, we're on a mission to bridge the gap between Web2 and
              Web3 development. We believe in the transformative power of
              blockchain technology and are committed to empowering software
              engineers from East Africa and the Global South to transition
              seamlessly into the world of Web3.
            </h1>
            <div className="px-8 sm:items-start sm:justify-center sm:px-0 sm:space-x-5 sm:flex mt-9">
              <a
                href="https://t.me/+bVl_-O03y0ZiOTNk"
                target="_blank"
                title="Join"
              ...
              <a
                href="https://t.me/cryptohyper250"
                target="_blank"
